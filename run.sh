...
chown $PLEX_MEDIA_SERVER_USER_UID:$PLEX_MEDIA_SERVER_USER_GID "$PLEX_MEDIA_SERVER_APPLICATION_SUPPORT_DIR"
chown $PLEX_MEDIA_SERVER_USER_UID:$PLEX_MEDIA_SERVER_USER_GID "$PLEX_MEDIA_SERVER_TMPDIR"
chown $PLEX_MEDIA_SERVER_USER_UID:$PLEX_MEDIA_SERVER_USER_GID "/media"

sudo -E -u plex mkdir -p "$PLEX_MEDIA_SERVER_APPLICATION_SUPPORT_DIR/Plex Media Server/Logs/"
...
xtail "$PLEX_MEDIA_SERVER_APPLICATION_SUPPORT_DIR/Plex Media Server/Logs/" &
